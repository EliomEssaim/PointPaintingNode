...
class Painter:
    def __init__(self, seg_net_index, calib_path=None):
        ...
        if seg_net_index == 0:
            ...
            print(f'Using Segmentation Network -- {SEG_NET_OPTIONS[seg_net_index]}')
            config_file = './mmseg/configs/deeplabv3plus/deeplabv3plus_r18-d8_512x1024_80k_cityscapes.py'
            checkpoint_file = './mmseg/checkpoints/deeplabv3plus_r18-d8_512x1024_80k_cityscapes_20201226_080942-cff257fe.pth'
